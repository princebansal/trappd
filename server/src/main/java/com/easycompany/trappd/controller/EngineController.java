...
public class EngineController {
  ...
  @ResponseBody
  public ResponseEntity<BaseResponse> uploadDocument(MultipartHttpServletRequest data)
      throws IOException {

    return ResponseEntity.ok(engineService.uploadDataToS3(data.getFile("data")));
  }
}
