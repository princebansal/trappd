package com.easycompany.trappd.filter.gzip;
...
public final class GZipResponseUtil {
   ...
   * elsewhere.
   *
   * <p>On a unix system to reproduce do <code>gzip -n empty_file</code>. -n tells gzip to not
   ...
   */
  public static boolean shouldGzippedBodyBeZero(
      byte[] compressedBytes, HttpServletRequest request) {
   ...
   * <p>
   *
   * <p>This is need when a gzipped body is returned so that browsers can properly decompress it.
   *
   ...
   *     javax.servlet.ServletResponse)} method and the set header is ignored.
   */
